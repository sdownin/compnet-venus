...
gf <- gof(fit, nsim=nsim, statistics=c(dsp, esp, deg, geodesic), parallel = "multicore", ncpus = detectCores())  ## rocpr
gof.file <- sprintf('/home/sdowning/compnet/results/amj_rnr/gof_%s_pd%s_R%s_%s_nsim%s.rds', firm_i, nPeriod, R, m_x, nsim)
