...
gf <- gof(fit, nsim=nsim, statistics=c(dsp), parallel = parallel, ncpus = ncpus)  ## rocpr
gof.file <- sprintf('/home/sdowning/compnet/results/amj_rnr/gof_%s_pd%s_R%s_%s_nsim%s_dsp.rds', firm_i, nPeriod, R, m_x, nsim)
