...
m4testsave <-   nets ~ edges + gwesp(0, fixed = T) +  gwdegree(0, fixed=T) + 
...
saveRDS(fits[[firm_i]][[m_x]]@effects, file='/home/sdowning/compnet/results/testsave_effects_rds.rds')
saveRDS(fits[[firm_i]][[m_x]]@boot, file='/home/sdowning/compnet/results/testsave_boot_rds.rds')

saveRDS(fits, file=fits.file)

save(fits[[firm_i]][[m_x]]@boot, file='/home/sdowning/compnet/results/testsave_boot_rdata.RData')
save(fits[[firm_i]][[m_x]]@effects, file='/home/sdowning/compnet/results/testsave_effects_rdata.RData')
