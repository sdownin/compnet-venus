...
cs.conm.tic.map <- c(
  `ALPHABET INC`='GOOG'
  ###
  ### TODO: Add mappings for other missed public firms
  ###
)
...
## SAVE REGRESSION DATAFRAME TO CSV
write.csv(df.sub, file=sprintf("acqlogit_reg_data_sample_313_%s_rivals_acquisitions.csv",name_i), row.names = F)
