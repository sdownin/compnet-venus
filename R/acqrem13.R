...
dms <- dim(ar.cov.na0)
ar.cov.na0.2 <- array(dim=c(dms[1], dms[2] + 1, dms[3]))
ar.cov.na0.2[ , 1:(dms[2]), ] <- ar.cov.na0
ar.cov.na0.2[ , (dms[2]+1), ] <- ar.cov.na0.2[ , 1, ] * ar.cov.na0.2[ , 5, ]

cat("done.\n")
##
covar <- list(CovSnd=ar.cov.na0.2)
##
